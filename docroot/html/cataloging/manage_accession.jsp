...
<liferay-portlet:actionURL name="manageAccession" varImpl="manageAccessionURL">
	<liferay-util:param name="page" value="/html/cataloging/manage_accession.jsp"></liferay-util:param>
</liferay-portlet:actionURL>



<aui:form method="post" action="<%= manageAccessionURL %>" name="fm">
	...
	<liferay-ui:search-container delta="20" 
		...
		<liferay-ui:search-container-results>
			...
			total = CatalogItemLocalServiceUtil.countByCompanyGroup(companyId, groupId);
			
			
			List<CatalogItem> catalogItems = CatalogItemLocalServiceUtil.getByCompanyGroup(companyId, groupId,
		...
		<liferay-ui:search-container-row
			...
			<liferay-ui:search-container-column-text
				name="released">
				<kencana:status-display 
					status="<%= catalogItem.getReleased() %>"
					trueText="released"
					falseText="unreleased" />
			
			</liferay-ui:search-container-column-text>
			<liferay-ui:search-container-column-text
					name="barcode"
					value="<%= catalogItem.getBarcode() %>"
					orderable="<%= false %>"
			/>
			<liferay-ui:search-container-column-text
					name="createDate"
