...
<%@ include file="/html/patron/users_admin/init.jsp" %>
...
<liferay-ui:error key="<%= NoSuchListTypeException.class.getName() + className + /".emailAddress/" %>" message="please-select-a-type" />
