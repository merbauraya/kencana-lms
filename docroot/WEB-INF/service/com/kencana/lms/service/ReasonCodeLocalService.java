...
/**
 * Provides the local service interface for ReasonCode. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mazlan Mat
 * @see ReasonCodeLocalServiceUtil
...
public interface ReasonCodeLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ReasonCodeLocalServiceUtil} to access the reason code local service. Add custom service methods to {@link com.kencana.lms.service.impl.ReasonCodeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
