...
/**
 * Provides the local service interface for CatalogTemplateTag. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mazlan Mat
 * @see CatalogTemplateTagLocalServiceUtil
...
public interface CatalogTemplateTagLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CatalogTemplateTagLocalServiceUtil} to access the catalog template tag local service. Add custom service methods to {@link com.kencana.lms.service.impl.CatalogTemplateTagLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
