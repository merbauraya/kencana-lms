...
import com.kencana.lms.service.MarcTagLocalService;
...
/**
 * Provides the base implementation for the marc tag local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.kencana.lms.service.impl.MarcTagLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class MarcTagLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements MarcTagLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.kencana.lms.service.MarcTagLocalServiceUtil} to access the marc tag local service.
	 */
	...
	@Override
	public MarcTag addMarcTag(MarcTag marcTag) throws SystemException {
		marcTag.setNew(true);

		return marcTagPersistence.update(marcTag);
	}
	 ...
	 */
	@Override
	public MarcTag createMarcTag(long tagId) {
		return marcTagPersistence.create(tagId);
	}
	...
	@Override
	public MarcTag deleteMarcTag(long tagId)
		throws PortalException, SystemException {
		return marcTagPersistence.remove(tagId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MarcTag deleteMarcTag(MarcTag marcTag) throws SystemException {
		return marcTagPersistence.remove(marcTag);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MarcTag.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return marcTagPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return marcTagPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return marcTagPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return marcTagPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return marcTagPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public MarcTag fetchMarcTag(long tagId) throws SystemException {
		return marcTagPersistence.fetchByPrimaryKey(tagId);
	}
	 ...
	 */
	@Override
	public MarcTag getMarcTag(long tagId)
		throws PortalException, SystemException {
		return marcTagPersistence.findByPrimaryKey(tagId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return marcTagPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MarcTag> getMarcTags(int start, int end)
		throws SystemException {
		return marcTagPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getMarcTagsCount() throws SystemException {
		return marcTagPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MarcTag updateMarcTag(MarcTag marcTag) throws SystemException {
		return marcTagPersistence.update(marcTag);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.kencana.lms.model.MarcTag",
			marcTagLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.kencana.lms.model.MarcTag");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = marcTagPersistence.getDataSource();
	...
	private MarcTagLocalServiceClpInvoker _clpInvoker = new MarcTagLocalServiceClpInvoker();
}