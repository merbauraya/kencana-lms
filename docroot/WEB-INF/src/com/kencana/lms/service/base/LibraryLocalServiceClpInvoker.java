...
public class LibraryLocalServiceClpInvoker {
	public LibraryLocalServiceClpInvoker() {
		...
		_methodName160 = "findByGroupCompany";

		_methodParameterTypes160 = new String[] { "long", "long" };

		_methodName161 = "findByCompany";

		_methodParameterTypes161 = new String[] { "long", "int", "int" };

		_methodName162 = "findByCompany";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return LibraryLocalServiceUtil.addLibrary((com.kencana.lms.model.Library)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return LibraryLocalServiceUtil.deleteLibrary((com.kencana.lms.model.Library)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return LibraryLocalServiceUtil.updateLibrary((com.kencana.lms.model.Library)arguments[0]);
		}
		...
		if (_methodName160.equals(name) &&
			...
			return LibraryLocalServiceUtil.findByGroupCompany(((Long)arguments[0]).longValue(),
				((Long)arguments[1]).longValue());
		}

		if (_methodName161.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes161, parameterTypes)) {
			return LibraryLocalServiceUtil.findByCompany(((Long)arguments[0]).longValue(),
				((Integer)arguments[1]).intValue(),
				((Integer)arguments[2]).intValue());
		}
