...
import com.kencana.lms.service.CircTransHistoryLocalService;
...
/**
 * Provides the base implementation for the circ trans history local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.kencana.lms.service.impl.CircTransHistoryLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class CircTransHistoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CircTransHistoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.kencana.lms.service.CircTransHistoryLocalServiceUtil} to access the circ trans history local service.
	 */
	...
	@Override
	public CircTransHistory addCircTransHistory(
		CircTransHistory circTransHistory) throws SystemException {
		circTransHistory.setNew(true);

		return circTransHistoryPersistence.update(circTransHistory);
	}
	 ...
	 */
	@Override
	public CircTransHistory createCircTransHistory(long transId) {
		return circTransHistoryPersistence.create(transId);
	}
	...
	@Override
	public CircTransHistory deleteCircTransHistory(long transId)
		throws PortalException, SystemException {
		return circTransHistoryPersistence.remove(transId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CircTransHistory deleteCircTransHistory(
		CircTransHistory circTransHistory) throws SystemException {
		return circTransHistoryPersistence.remove(circTransHistory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CircTransHistory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return circTransHistoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return circTransHistoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CircTransHistory fetchCircTransHistory(long transId)
		throws SystemException {
		return circTransHistoryPersistence.fetchByPrimaryKey(transId);
	}
	 ...
	 */
	@Override
	public CircTransHistory getCircTransHistory(long transId)
		throws PortalException, SystemException {
		return circTransHistoryPersistence.findByPrimaryKey(transId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return circTransHistoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CircTransHistory> getCircTransHistories(int start, int end)
		throws SystemException {
		return circTransHistoryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCircTransHistoriesCount() throws SystemException {
		return circTransHistoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CircTransHistory updateCircTransHistory(
		CircTransHistory circTransHistory) throws SystemException {
		return circTransHistoryPersistence.update(circTransHistory);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.kencana.lms.model.CircTransHistory",
			circTransHistoryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = circTransHistoryPersistence.getDataSource();
	...
	private CircTransHistoryLocalServiceClpInvoker _clpInvoker = new CircTransHistoryLocalServiceClpInvoker();
}