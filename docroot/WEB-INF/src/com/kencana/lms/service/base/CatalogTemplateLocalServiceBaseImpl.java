...
import com.kencana.lms.service.CatalogTemplateLocalService;
...
/**
 * Provides the base implementation for the catalog template local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.kencana.lms.service.impl.CatalogTemplateLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class CatalogTemplateLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CatalogTemplateLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.kencana.lms.service.CatalogTemplateLocalServiceUtil} to access the catalog template local service.
	 */
	...
	@Override
	public CatalogTemplate addCatalogTemplate(CatalogTemplate catalogTemplate)
		throws SystemException {
		catalogTemplate.setNew(true);

		return catalogTemplatePersistence.update(catalogTemplate);
	}
	 ...
	 */
	@Override
	public CatalogTemplate createCatalogTemplate(long templateId) {
		return catalogTemplatePersistence.create(templateId);
	}
	...
	@Override
	public CatalogTemplate deleteCatalogTemplate(long templateId)
		throws PortalException, SystemException {
		return catalogTemplatePersistence.remove(templateId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CatalogTemplate deleteCatalogTemplate(
		CatalogTemplate catalogTemplate) throws SystemException {
		return catalogTemplatePersistence.remove(catalogTemplate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CatalogTemplate.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return catalogTemplatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return catalogTemplatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CatalogTemplate fetchCatalogTemplate(long templateId)
		throws SystemException {
		return catalogTemplatePersistence.fetchByPrimaryKey(templateId);
	}
	 ...
	 */
	@Override
	public CatalogTemplate getCatalogTemplate(long templateId)
		throws PortalException, SystemException {
		return catalogTemplatePersistence.findByPrimaryKey(templateId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return catalogTemplatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CatalogTemplate> getCatalogTemplates(int start, int end)
		throws SystemException {
		return catalogTemplatePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCatalogTemplatesCount() throws SystemException {
		return catalogTemplatePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CatalogTemplate updateCatalogTemplate(
		CatalogTemplate catalogTemplate) throws SystemException {
		return catalogTemplatePersistence.update(catalogTemplate);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.kencana.lms.model.CatalogTemplate",
			catalogTemplateLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = catalogTemplatePersistence.getDataSource();
	...
	private CatalogTemplateLocalServiceClpInvoker _clpInvoker = new CatalogTemplateLocalServiceClpInvoker();
}