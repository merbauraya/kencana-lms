...
import com.kencana.lms.service.PatronLocalService;
...
/**
 * Provides the base implementation for the patron local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.kencana.lms.service.impl.PatronLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 ...
 * @generated
 */
public abstract class PatronLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements PatronLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.kencana.lms.service.PatronLocalServiceUtil} to access the patron local service.
	 */
	...
	@Override
	public Patron addPatron(Patron patron) throws SystemException {
		patron.setNew(true);

		return patronPersistence.update(patron);
	}
	 ...
	 */
	@Override
	public Patron createPatron(long patronId) {
		return patronPersistence.create(patronId);
	}
	...
	public Patron deletePatron(long patronId)
		...
		return patronPersistence.remove(patronId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Patron deletePatron(Patron patron) throws SystemException {
		return patronPersistence.remove(patron);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Patron.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return patronPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return patronPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return patronPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return patronPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Patron fetchPatron(long patronId) throws SystemException {
		return patronPersistence.fetchByPrimaryKey(patronId);
	}
	...
	public Patron getPatron(long patronId)
		throws PortalException, SystemException {
		return patronPersistence.findByPrimaryKey(patronId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return patronPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Patron> getPatrons(int start, int end)
		throws SystemException {
		return patronPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getPatronsCount() throws SystemException {
		return patronPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Patron updatePatron(Patron patron) throws SystemException {
		return patronPersistence.update(patron);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.kencana.lms.model.Patron",
			patronLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.kencana.lms.model.Patron");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = patronPersistence.getDataSource();
	...
	private PatronLocalServiceClpInvoker _clpInvoker = new PatronLocalServiceClpInvoker();
}