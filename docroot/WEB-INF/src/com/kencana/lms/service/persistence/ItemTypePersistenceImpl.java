...
import com.kencana.lms.model.impl.ItemTypeImpl;
import com.kencana.lms.model.impl.ItemTypeModelImpl;
...
public class ItemTypePersistenceImpl extends BasePersistenceImpl<ItemType>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYGROUP = new FinderPath(ItemTypeModelImpl.ENTITY_CACHE_ENABLED,
			ItemTypeModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<ItemType> findByCompanyGroup(long companyId, long groupId)
	 ...
	 */
	@Override
	public ItemType findByCompanyGroup_First(long companyId, long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchItemTypeException, SystemException {
		ItemType itemType = fetchByCompanyGroup_First(companyId, groupId,
				orderByComparator);
	 ...
	 */
	@Override
	public ItemType fetchByCompanyGroup_First(long companyId, long groupId,
		OrderByComparator orderByComparator) throws SystemException {
		List<ItemType> list = findByCompanyGroup(companyId, groupId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public ItemType findByCompanyGroup_Last(long companyId, long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchItemTypeException, SystemException {
		ItemType itemType = fetchByCompanyGroup_Last(companyId, groupId,
				orderByComparator);
	 ...
	 */
	@Override
	public ItemType fetchByCompanyGroup_Last(long companyId, long groupId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<ItemType> list = findByCompanyGroup(companyId, groupId, count - 1,
	 ...
	 */
	@Override
	public ItemType[] findByCompanyGroup_PrevAndNext(long itemTypeId,
		...
		try {
			...
			array[0] = getByCompanyGroup_PrevAndNext(session, itemType,
					companyId, groupId, orderByComparator, true);

			array[1] = itemType;

			array[2] = getByCompanyGroup_PrevAndNext(session, itemType,
	...
	protected ItemType getByCompanyGroup_PrevAndNext(Session session,
	...
	public void removeByCompanyGroup(long companyId, long groupId)
		throws SystemException {
		for (ItemType itemType : findByCompanyGroup(companyId, groupId,
	...
	private static final String _FINDER_COLUMN_COMPANYGROUP_COMPANYID_2 = "itemType.companyId = ? AND ";
	private static final String _FINDER_COLUMN_COMPANYGROUP_GROUPID_2 = "itemType.groupId = ?";
	...
	@Override
	public ItemType updateImpl(com.kencana.lms.model.ItemType itemType)
		throws SystemException {
		itemType = toUnwrappedModel(itemType);
	...
	protected ItemType toUnwrappedModel(ItemType itemType) {
		...
		itemTypeImpl.setNotForLoan(itemType.isNotForLoan());
		itemTypeImpl.setCoverId(itemType.getCoverId());
		itemTypeImpl.setCheckoutMessage(itemType.getCheckoutMessage());
		itemTypeImpl.setCheckinMessage(itemType.getCheckinMessage());
		itemTypeImpl.setRentalRate(itemType.getRentalRate());
		itemTypeImpl.setCompanyId(itemType.getCompanyId());
		itemTypeImpl.setGroupId(itemType.getGroupId());
		itemTypeImpl.setUserId(itemType.getUserId());
		itemTypeImpl.setCreateDate(itemType.getCreateDate());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.kencana.lms.model.ItemType")));
