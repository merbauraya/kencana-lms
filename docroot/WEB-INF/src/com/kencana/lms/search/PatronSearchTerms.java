...
public class PatronSearchTerms extends PatronDisplayTerms {

	public PatronSearchTerms(PortletRequest portletRequest) {
		...
		cardNumber = DAOParamUtil.getString(portletRequest, CARD_NUMBER);
	}
