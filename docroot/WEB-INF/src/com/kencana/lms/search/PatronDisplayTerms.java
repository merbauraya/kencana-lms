...
public class PatronDisplayTerms extends DisplayTerms {
	...
	public PatronDisplayTerms(PortletRequest portletRequest) {
		...
		cardNumber = ParamUtil.getString(portletRequest, CARD_NUMBER);
	}
